...
export default function CopyIbanButton() {
  ...
  return (
    <button
      ...
      className={`mt-8 w-full py-3.5 font-semibold text-sm tracking-widest uppercase transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer ${
        copied
