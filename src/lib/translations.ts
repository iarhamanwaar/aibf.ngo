...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "impact.stat1.number": "10,000+",
    "impact.stat1.label": "Patients Served",
    "impact.stat1.sub": "Across 5 dispensaries & 4 health camps",
    "impact.stat2.number": "265+",
    "impact.stat2.label": "Ration Bags",
    "impact.stat2.sub": "Distributed in Ramadan 2025 & 2026",
    "impact.stat3.number": "2,500+",
    "impact.stat3.label": "Trees Planted",
    "impact.stat3.sub": "Across Bhera, Bugga & Lahore",
    "impact.stat4.number": "70+",
    "impact.stat4.label": "Women Trained",
    "impact.stat4.sub": "At 2 sewing centers in Maliyar & Bugga",
    "impact.quote":
    ...
    "footer.link.stories": "Stories of Impact",
    ...
    "footer.link.services": "Our Programs",
  },
  ur: {
    // Navbar
    "nav.about": "تعارف",
    ...
    "impact.stat1.number": "10,000+",
    "impact.stat1.label": "مریض خدمت",
    "impact.stat1.sub": "5 ڈسپنسریوں اور 4 طبی کیمپوں میں",
    "impact.stat2.number": "265+",
    "impact.stat2.label": "راشن بیگ",
    "impact.stat2.sub": "رمضان 2025 اور 2026 میں تقسیم",
    "impact.stat3.number": "2,500+",
    "impact.stat3.label": "درخت لگائے",
    "impact.stat3.sub": "بھیرہ، بگہ اور لاہور میں",
    "impact.stat4.number": "70+",
    "impact.stat4.label": "خواتین تربیت یافتہ",
    "impact.stat4.sub": "ملیار اور بگہ کے 2 سلائی مراکز میں",
    "impact.quote":
    ...
    "footer.link.stories": "اثرات کی کہانیاں",
    "footer.link.gallery": "گیلری",
